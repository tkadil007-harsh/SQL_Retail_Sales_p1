...
--  sold id more than 10 in the month of NOV-2022
...
-- 4. Write a SQL query to find the average age of customers who purchased an item from 'Beauty' 
-- category
...
-- 7. Write a SQL query to calculate the average sale of each month. Find the best selling 
-- month in each year (IMP for interview)
...
-- (Example: Morning <=12, After Between 12 & 17, Evening > 17)
